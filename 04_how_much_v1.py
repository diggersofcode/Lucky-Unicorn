...
integer between 1 and 10. If it is, this amount becomes the balance in there
account"""


user_balance = int(input("How much do you want to ply with (must be an integer between 1 and 10"))
